package com.vova_cons.hundread_games.asteroids.services;
...
public class ServiceLocator {
    ...
    private Map<Class<? extends Service>, Service> servicesMap = new HashMap<Class<? extends Service>, Service>();
